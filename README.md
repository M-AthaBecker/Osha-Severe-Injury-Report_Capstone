...
| **Python / Jupyter Notebook** | EDA, statistical analysis, skewness, outlier detection, 10 visualizations, forecasting |
...
| Dashboard | Contents |
|---|---|
| **Time Analysis** | Monthly trend, forecast, and day of week — all filterable by year |
| **Industry Analysis** | Outcomes by state, by broad industry, and bubble chart |
